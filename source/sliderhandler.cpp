...
SliderFieldHandler::SliderFieldHandler(wxFrame* parent): wxPanel(parent, wxID_ANY)
{
    ...
    cutoffSlider->Bind(wxEVT_SLIDER, &SliderFieldHandler::setCutoff, this); // New bind
    ...
    resonanceSlider->Bind(wxEVT_SLIDER, &SliderFieldHandler::setResonance, this); // New bind
